  ...
  return (
    <div ref={containerRef} className={`relative inline-flex ${className ?? ''}`}>
      ...
      <div
        ...
        role="tooltip"
        aria-hidden={!isOpen}
        className={`absolute z-30 w-56 rounded-2xl border border-white/10 bg-[#0b1220]/95 p-3 text-[11px] text-slate-200 shadow-[0_20px_40px_rgba(0,0,0,0.35)] transition-all duration-200 ${
