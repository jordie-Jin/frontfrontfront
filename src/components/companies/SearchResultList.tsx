      ...
      <div className="mt-6">
        ...
        {!isLoading && !error && items.length > 0 && (
          <div className="overflow-hidden rounded-2xl border border-white/10">
            <div className="grid grid-cols-[2fr_2fr_1fr_1fr] gap-2 bg-white/10 px-4 py-3 text-[11px] uppercase tracking-[0.3em] text-slate-400">
              <span>기업명</span>
              <span>영문명</span>
              <span>종목코드</span>
              <span>ID</span>
              ...
              {items.map((company) => {
                ...
                return (
                  <button
                    ...
                    className={`grid w-full grid-cols-[2fr_2fr_1fr_1fr] items-center gap-2 px-4 py-4 text-left text-sm transition ${
                      isSelected
